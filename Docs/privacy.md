...
### 1.1 Information You Don't Provide
...
**User Accounts (Optional - OwlGuard):**
...
### 2.2 Account Management (If You Have an Account)
...
### 3.2 Account Data (If You Have an Account)
